...
Managing your contacts is essential for staying connected and organized. This section explains the features and functionalities of the Contacts module in the webmail platform. Whether you are keeping track of personal connections, professional networks, or client relationships, |product| makes it easy to store, organize, and access your contacts effortlessly.
...
In the contacts section, you will find two primary address books:
...
#.	From the left sidebar click the **Contacts**.
#.	In the Navigation Panel, click the **Contacts** address book.
...
#.	From the left sidebar click the **Contacts** section.
#.	In the Navigation Panel, click the **Emailed Contacts** address book.
...
#.	Click the **NEW** button located on the top bar. A new board will appear.
...
#.	Locate and click the contact you wish to edit from the main panel.
#.	Enter the contact’s information.
...
#.	Select the **Contacts** from your left sidebar.
#.	In the Navigation Panel, select the address book that contains the contact you wish to edit.
#.	Locate and right-click the contact you want to edit from the main panel.
...
#.	Select the **Contacts** from your left sidebar.
#.	In the Navigation Panel, select the address book that contains the contact you wish to edit.
#.	Locate and right-click the contact you wish to delete from the main panel.
...
#.	Select the **Contacts** from your left sidebar.
#.	In the Navigation Panel, right-click the address book where you want to add the address book.
...
#.	Select the **Contacts** from your left sidebar.
#.	In the Navigation Panel, click the address book that contains the contact you wish to move.
#.	Right-click the contact you want to move.
...
#.	Select the **Contacts** from your left sidebar.
#.	In the Navigation Panel, right-click the address book you wish to move.
#.	Select **Move** from the drop-down menu. A new window appears.
...
#.	Select the **Contacts** from your left sidebar.
#.	In the Navigation Panel, right-click the address book you wish to edit.
...
#.	Select the **Contacts** from your left sidebar.
#.	In the Navigation Panel, right-click the address book you wish to delete.
...
2.	Click the contact group, and it will automatically populate the **To** field with all the addresses included in the contact group.
...
You can share your address book with colleagues or external users so they can view and access the contacts stored in it.

How to Share a Contact Group
-----------------------------

1. Go to the **Contacts** section in the app.
2. Create a new group or select an existing **Group**.
3. To create a group, click **New Group**, add contacts, and assign the group to a folder.
4. To share an existing group, make sure it is stored in a folder that you can share.
5. Move the group to a specific folder, or create a new folder just for that group.
6. This lets you share only the contents of that folder.
7. Right-click the folder and select **Share**.
8. Choose the users you want to share with and set their permission level:
   
   * **Can View**
   * **Can Edit**

9. Confirm the shared content.
10. Users will only see the contacts and groups inside that folder.
11. Your personal contacts and other folders will remain private.

Filtering Your View
-------------------

To control what you see in **Contacts**, use the **View Filter** to display:

* **Only Contacts**
* **Only Groups**
* **Both**

This helps you focus on the items that matter most.
...
1.	Select the **Contacts** from your left sidebar.
2.	In the Navigation Panel, right-click the address book you wish to share. A new window appears.
...
1.	Select the **Contacts** from your left sidebar.
2.	In the Navigation Panel, right-click the address book you wish to export.
